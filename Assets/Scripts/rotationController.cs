...
void runMovement()
    {
       ...
       // if (currentLine >= data.Length)
        ...
        {
            rightStickLight.transform.eulerAngles = new Vector3(rightStickLight.transform.eulerAngles.x, rightStickLight.transform.eulerAngles.y, 0 - float.Parse(row[1])*20);
            leftStickLight.transform.eulerAngles = new Vector3(leftStickLight.transform.eulerAngles.x, leftStickLight.transform.eulerAngles.y, float.Parse(row[0])*20);
            ...
            //  rightStickDark.transform.eulerAngles = new Vector3(rightStickDark.transform.eulerAngles.x, rightStickDark.transform.eulerAngles.y, 0 - float.Parse(row[1]) * 20);
            //  leftStickDark.transform.eulerAngles = new Vector3(leftStickDark.transform.eulerAngles.x, leftStickDark.transform.eulerAngles.y,  float.Parse(row[0]) * 20);
